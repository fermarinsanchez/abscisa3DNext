...
const Home = ({ projects, news }) => {
  ...
  return (
    <>
      ...
      <section id="Academia">
        <div className={style.container_academia}>
        
            <InView className={style.imgAcademiaContainer}>
              <div className={style.imgAcademia}  >
                <img src={'/images/academia-home.jpg'} alt="aprende a manejar tu scanner 3d" />
              </div>

            </InView>
              <h3>Academia #ABSCISA3d</h3>
              <p className={style.academia_text} >Formación personalizada, on líne o presencial con el contenido que necesitas para capturar,  procesar y modelizar la nube de puntos
              </p>
